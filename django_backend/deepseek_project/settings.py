...
REMOTE_RETRIEVAL_MAX_QUERIES = _get_int_env('REMOTE_RETRIEVAL_MAX_QUERIES', 3)
REMOTE_RETRIEVAL_ENABLE_RELAXED = _get_bool_env('REMOTE_RETRIEVAL_ENABLE_RELAXED', False)
DB_RETRIEVAL_TOP_K = _get_int_env('DB_RETRIEVAL_TOP_K', 3)
...
WEB_SEARCH_MAX_RESULTS = _get_int_env('WEB_SEARCH_MAX_RESULTS', 2)
